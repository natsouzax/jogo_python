...
def fase3_1():
         ...
         while fase3:
               ...
               arvore1 =  pygame.draw.rect(tela,preto,(180,90,90,220))
               arvore2 =  pygame.draw.rect(tela,preto,(0,0,60,150))
               arvore3 =  pygame.draw.rect(tela,red,(90*3,0,90,80))
               arvore4 =  pygame.draw.rect(tela,preto,(90*3,60*4,90,160))
               ...
               barranco6=  pygame.draw.rect(tela,preto,(550,200,250,60))
